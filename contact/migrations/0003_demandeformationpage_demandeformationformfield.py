# Generated by Django 5.2.6 on 2026-02-19 10:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('contact', '0002_contactformpage_consent_required_and_more'),
        ('wagtailcore', '0095_groupsitepermission'),
    ]

    operations = [
        migrations.CreateModel(
            name='DemandeFormationPage',
            fields=[
        ...
        migrations.CreateModel(
            name='DemandeFormationFormField',
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='contact.demandeformationpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
